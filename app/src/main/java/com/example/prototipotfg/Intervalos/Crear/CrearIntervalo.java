...
public class CrearIntervalo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView peticion = findViewById(R.id.Id_intervalo);
        ...
        LinearLayout opciones = findViewById(R.id.opciones_crear_intervalo);
    ...
    public void reproducir(View view) throws IOException {
        AssetFileDescriptor afd = getAssets().openFd("piano/" + this.octavaReproducir.getPath() + this.notaInicio.getPath());
        Reproductor.getInstance().reproducirNota(afd);
        afd.close();
