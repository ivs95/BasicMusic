...
public class CrearAcorde extends Activity {
    ...
    public void reproducirNotaInicioAcorde(View view) {
        String ruta = "piano/" + this.octavaInicio.getPath() + this.notaInicio.getPath();
        reproduceNota(ruta);
    }
    ...
    public void reproduceReferenciaCrearAcorde(View view) {
        String ruta = "piano/" + this.octavaInicio.getPath() + Notas.LA.getPath();
        reproduceNota(ruta);
    }
